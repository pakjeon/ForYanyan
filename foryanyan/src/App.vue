<!--
 * :file description: 
 * :name: \ForYanyan\foryanyan\src\App.vue
 * :author: PakJeon
 * :copyright: (c) 2023, Tungee
 * :date created: 2023-11-05 10:00:49
 * :last editor: PakJeon
 * :date last edited: 2023-11-05 11:21:29
-->
<template>
  <div id="app">
    ...
    <footer class="footer">
      <a class="btn-beian" href="https://beian.miit.gov.cn/" target="_blank"
        >粤ICP备2023119367号-1</a
      >
      <div class="beian">
        <img class="icon-beian" src="./assets/beian.png" />
        <a
          class="btn-beian"
          href="https://beian.mps.gov.cn/#/query/webSearch?code=44060002000106"
          rel="noreferrer"
          target="_blank"
          >粤公网安备44060002000106</a
        >
      </div>
    </footer>
  </div>
